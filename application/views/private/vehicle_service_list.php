    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body" id="pageContent">
            <?php echo form_open_multipart( adminurl('vehicle_service_list'),['method'=>'get']); ?>
                <div class="row">
...
<div id="myEditModal" class="modal fade" role="dialog">
  ...
  <script>
    ...
    function getTotalRecordsData( qparam ){  
        $.ajax({
          url: '<?=adminurl('Vehicle_service_list/getDataList?');?>'+qparam,
          type: "POST",
...
function loadCityData( qparam ){
    ...
    $('#responseData').DataTable({
        ...
        "serverSide": true,
        "ajax" : {
            "url" : '<?=adminurl('Vehicle_service_list/getDataList?');?>'+newQueryParam,
            "type":'POST', 
            dataSrc : (res)=>{ 
...
function action_render(data, type, row, meta){
    ...
    if(type === 'display'){ 
        ...
        if( editMode == 'yes' ){
        output += '<a href="<?=adminurl('add_veh_service')?>/?id='+row.enc_id+'&redirect=<?=$redirect?>" class="btn btn-sm btn-info" data-toggle="tooltip" title="Edit" ><i class="fa fa-edit"></i></a> | ';
        }
        
        if( removeMode == 'yes' ){
        output += '<a href="<?=adminurl('vehicle_service_list/delete')?>/?delId='+row.enc_id+'&redirect=<?=$redirect?>" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Edit"  onclick="return confirm(`Do you want delete this record`)"><i class="fa fa-trash"></i></a> | ';
        }
        
        output += '<br/><br/>'; 
        output += '<a href="<?=adminurl('add_veh_service')?>?vehicle_con_id='+row.vehicle_con_id+'&redirect=<?=$redirect?>" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Add More"><i class="fa fa-plus"></i></a> | ';
        ...
        output += ' | <a href="<?=adminurl('vehicle_service_list')?>?vcid='+row.vehicle_con_idmd+'&is_history=yes" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Record History"><i class="fa fa-table"></i></a>';
