      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <?php echo form_hidden('contenttype', 'editapproval');?>
            <?php echo form_hidden('datacategory', 'editapproval');?>
...
<?php if( VIEW ==='yes'){ 
		echo  anchor( adminurl('Editapprovalreason/view'),'View',array('class'=>'btn btn-sm btn-success fa fa-sign-out') ); 
		} 
?>
</div>  
</div>                             
