      ...
      <div class="row"> 
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary"> 
            ...
            <div class="box-body"> 
            <?php echo form_open_multipart( adminurl('Addvehiclecmspage/')); ?>  
            <?php echo form_hidden('id', $id);?>  
            <?php echo form_hidden('domainid', $domainid);?>
            <?php echo form_hidden('pageurl', $pageurl);?> 
            <?php echo form_hidden('pagetype', 'vehicle');?>  
<input type="hidden" name="cabname" value="<?=$cabname;?>" id="cabname">
...
<?php echo form_label('Vehicle Type', 'tableid');?> 
<?php echo form_dropdown(array('name'=>'tableid','required'=>'required','class'=>'form-control select22','onchange'=>'getname();','id'=>'tableid'), get_dropdownsmulti('pt_vehicle_model',null,'id','model','Vehicle'),set_value('tableid',$tableid));?>  
</div>  

 <div class="form-group"> 
<?php echo form_label('Title/Heading', 'titleorheading');?> 
<?php echo form_input(array('name'=>'titleorheading','required'=>'required','class'=>'form-control','placeholder'=>'Title/Heading....','id'=>'titleorheading','autocomplete'=>'off'), set_value('titleorheading',$titleorheading));?> 
</div>
...
<?php echo form_textarea( array('name'=>'content','class'=>'form-control textarea','rows'=> '15','cols'=> '10','placeholder'=>'Content...','autocomplete'=>'off') , $content  ); ?>
</div>
</div>
...
<?php if( VIEW ==='yes'){ 
		echo  anchor( adminurl('Viewvehiclecms'),'View',array('class'=>'btn btn-sm btn-success fa fa-sign-out') ); 
		} 
?>
</div>  
</div>                             
...
<script type="text/javascript">
  function getname(){
    var getopt = $('#tableid').find('option:selected').text();
    $('#cabname').val(getopt);
    $('#titleorheading').val(getopt);
  }
</script>