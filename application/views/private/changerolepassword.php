...
<?php echo form_input(array('type'=>'email','name'=>'username','readonly'=>'readonly', 'value'=>set_value('username',$username),'class'=>'form-control','maxlength'=>'10','placeholder'=>'Enter mobileno...') );?> 
</div>
