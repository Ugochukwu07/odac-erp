...
<?php echo form_dropdown(array('name'=>'c_trip','required'=>'required','class'=>'form-control select22'),[''=>'-- Select Trip Type-- ','bike'=>'Bike Rental','outstation'=>'Outstaion','selfdrive'=>'Self Drive','monthly'=>'Monthly Rental'],set_value('c_trip',$c_trip)  );?> 
</div>
<div class="col-lg-3"> 
<?php echo form_label('Payment Mode', 'c_paymode');?>
<?php echo form_dropdown(array('name'=>'c_paymode', 'required'=>'required','class'=>'form-control select22','autocomplete'=>'off'),get_dropdownsmulti('paymode_list',array('status'=>'Active'),'paymode','mode_text_value',' Paymode--'), set_value('c_paymode',$c_paymode ) );?> 
</div>
</div>
