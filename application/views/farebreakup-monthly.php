...
<?php if($fare['triptype'] == 'monthly'){?>
    <div class="row"><div class="col-lg-6 col-xs-7"><b>Minimum Charged Per Day </b></div><div class="col-lg-6  col-xs-5">: <?php echo $fare['basefare'];?> INR / Day</div></div>   
