<section class="bannerbg background-centered">
  <div class="container">
   ...
   <!---/.left offer portion start-->
    ...
    </div> <i class="stm-rental-baloon_tail"></i></div>
    </div>
...
<div class="row">
 <div class="col-lg-12 col-xs-12" >
            ...
            <li class="<?php if($tab=='selfdrive' || $tab==''){ echo 'active';}?>"><a href="#SelfDrive" aria-controls="SelfDrive" role="tab" data-toggle="tab"><i class=" fa fa-map-marker"></i>&nbsp; Self Drive Car </a></li>
            <li class="<?php if($tab=='outstation'){ echo 'active';}?>"><a href="#Outstation" aria-controls="Outstation" role="tab" data-toggle="tab"><i class=" fa fa-taxi"></i>&nbsp; Taxi Service</a></li>
            <li class="<?php if($tab=='bike'){ echo 'active';}?>"><a href="#Bike" aria-controls="Bike" role="tab" data-toggle="tab"><i class=" fa fa-motorcycle"></i> Rent A Bike</a></li> 
            <li class="<?php if($tab=='monthly'){ echo 'active';}?>"><a href="#Monthly" aria-controls="Monthly" role="tab" data-toggle="tab"><i class=" fa fa-map-marker"></i>&nbsp; Monthly Rental </a></li>
            </ul>
...
<div role="tabpanel" class="tab-pane <?php if($tab=='selfdrive' || $tab==''){ echo 'active';}?>" id="SelfDrive">
...
<div role="tabpanel" class="tab-pane <?php if($tab=='outstation'){ echo 'active';}?>" id="Outstation">
<form action="<?php echo PEADEX;?>reservation.html"  method="get">
<input type="hidden" name="tabdata" value="outstation" />

<div class="row">
<div class="col-md-12 col-xs-12 radio">
<input type="radio" name="mode" value="oneway" id="1" required onClick="shownow(1)" <?php if($ttypemulti=='oneway'  || $ttypemulti==''){echo 'checked';} ?>>   
<label class="rdo" for="1">One Way </label>

<input type="radio" name="mode" value="roundtrip" id="2" required onClick="shownow(1)" <?php if($ttypemulti=='roundtrip'){echo 'checked';}?>>   
<label class="rdo " for="2"> Round Trip </label>

<input type="radio" name="mode" value="multicity" id="3" onClick="shownow(2)" <?php if($ttypemulti=='multicity'){echo 'checked';}?>>
...
<div role="tabpanel" class="tab-pane <?php if($tab=='bike'){ echo 'active';}?>" id="Bike">
<form  action="<?php echo PEADEX;?>reservation.html"  method="get">
...
<div role="tabpanel" class="tab-pane <?php if($tab=='monthly'){ echo 'active';}?>" id="Monthly">
<form  action="<?php echo PEADEX;?>reservation.html"  method="get">
