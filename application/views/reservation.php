    ...
    <div class="container">
        ...
        <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 headcab">
            <p>Book a Cab from <?= $sourcecityname . ' to ' . getexplode($destination, 0); ?>
                <span class="serchkm">
                    <?php if ($tab == 'outstation') {
                        echo 'Approx google (Return) Kms: ' . $distancreturn;
                    } ?> </span><span class="serchkm"> [Booking Date <?php echo $pickdatetime; ?> to <?php echo $dropdatetime; ?> total <?= $days; ?> days ] </span><span class="pull-right"><a href="<?php echo PEADEX; ?>" class="modify">Modify</a></span>
            </p>
        </div>
        ...
        <?php if (!empty($list)) { ?>
            <div class="row stm_rental_search_top">
                <div class="col-md-12 col-xs-12 col-lg-12">
                    ...
                    <div class="all-bar">
                        <div class="all-bar-made all-bar-width"></div>
                    </div>
                </div>
            </div>
        <?php  } ?>
