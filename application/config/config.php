...
if (!defined('FIREBASE_API_KEY_CUSTOMER')) define('FIREBASE_API_KEY_CUSTOMER', getenv('FIREBASE_API_KEY_CUSTOMER') ?: '');
if (!defined('GSTIN')) define('GSTIN', getenv('GSTIN') ?: '');
if (!defined('FROMMAIL')) define('FROMMAIL', getenv('FROMMAIL') ?: '');
if (!defined('FMAILER')) define('FMAILER', getenv('FMAILER') ?: '');
if (!defined('FCC')) define('FCC', getenv('FCC') ?: '');
if (!defined('FHOST')) define('FHOST', getenv('FHOST') ?: '');
if (!defined('FSERVERUSER')) define('FSERVERUSER', getenv('FSERVERUSER') ?: '');
if (!defined('FPASSWORD')) define('FPASSWORD', getenv('FPASSWORD') ?: '');
if (!defined('CABGST')) define('CABGST', getenv('CABGST') ?: 1);
if (!defined('CABADVNCE')) define('CABADVNCE', getenv('CABADVNCE') ?: 1);
if (!defined('ONLINECHARGE')) define('ONLINECHARGE', getenv('ONLINECHARGE') ?: 1);
if (!defined('ONLINETAX')) define('ONLINETAX', getenv('ONLINETAX') ?: 1);
if (!defined('TRIPADVANCE')) define('TRIPADVANCE', getenv('TRIPADVANCE') ?: 1);
if (!defined('SLIPCOLOR')) define('SLIPCOLOR', getenv('SLIPCOLOR') ?: '');
if (!defined('SLIPTEXTCLR')) define('SLIPTEXTCLR', getenv('SLIPTEXTCLR') ?: '');
if (!defined('RECAPTUAKEY')) define('RECAPTUAKEY', getenv('RECAPTUAKEY') ?: '');
if (!defined('RECAPTUASECRETKEY')) define('RECAPTUASECRETKEY', getenv('RECAPTUASECRETKEY') ?: '');
if (!defined('ADMINNOTIFY')) define('ADMINNOTIFY', getenv('ADMINNOTIFY') ?: '');
if (!defined('SMSAPI')) define('SMSAPI', getenv('SMSAPI') ?: '');
if (!defined('FACEBOOK_S')) define('FACEBOOK_S', getenv('FACEBOOK_S') ?: '');
if (!defined('LINKEDIN_S')) define('LINKEDIN_S', getenv('LINKEDIN_S') ?: '');
if (!defined('TWITTER_S')) define('TWITTER_S', getenv('TWITTER_S') ?: '');
if (!defined('YOUTUBE_S')) define('YOUTUBE_S', getenv('YOUTUBE_S') ?: '');
if (!defined('INSTAGRAM_S')) define('INSTAGRAM_S', getenv('INSTAGRAM_S') ?: '');
