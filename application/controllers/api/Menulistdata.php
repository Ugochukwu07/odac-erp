...
class Menulistdata extends CI_Controller{
	...
	if( ($_SERVER['REQUEST_METHOD'] == 'POST') ){
	        ...
	        $select = "a.id , a.modelid,  a.basefare, a.fareperkm, a.secu_amount, a.minkm_day,  b.model, b.image, b.thumbnail, c.vyear,c.seat, c.fueltype " ; 
		    $from = 'pt_fare as a';
		    ...
		    foreach( $getdata as $key=>$value ): 
				...
				'secu_amount'=> (string) $value['secu_amount'],
				 );
