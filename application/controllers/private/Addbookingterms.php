...
class Addbookingterms extends CI_Controller{
  ...
  public function index() {
	...
	$data['title'] = ( !empty($id) ? 'Update' : 'Add') .' Booking Terms'; 
   ...
   public function delete(){
	   ...
	   redirect(adminurl('Viewbookingterms'));
	 }
   }
