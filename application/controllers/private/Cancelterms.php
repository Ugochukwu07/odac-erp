...
class Cancelterms extends CI_Controller{
  ...
  public function index() {
	...
	$data['title'] = ( !empty($id) ? 'Update' : 'Add') .' Booking Cancel Terms'; 
	 
	 
	    $data['content'] = ""; 
		$data['contenttype'] = "cancel"; 
		$data['datacategory'] = "cancel"; 
		$data['status']="yes"; 
		$data['id'] = $id; 
	...
	//if( $this->input->post() == true ){  
     ...
     public function view() {
	        ...
	        $data['title'] = 'View Cancel Booking Terms';

	        $select = 'a.*, b.domain '; 
		    $from = ' pt_booking_terms as a';
		    
		    $where = [];
		    $where['a.contenttype'] = 'cancel'; 
		    ...
		    _viewlist( 'view_cancel_terms', $data );
   ...
   public function delete(){
	   ...
	   redirect(adminurl('Cancelterms/view'));
	 }
   }
