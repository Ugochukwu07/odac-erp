...
class Vehicle_service_list extends CI_Controller{
	 var $pagename; 
     function __construct() {
         parent::__construct();  
	     adminlogincheck();
	     $this->pagename = 'vehicle_service_list';
     }	
	...
	public function index(){
            ...
            $data['exporturl'] =  adminurl('Vehicle_service_list?is_export=yes&vcid='.$get_vcid.'&vcid2='.$get_vcid2.'&status='.$get_status.'&is_history='.$is_history ); 
            $data['vcid'] = $get_vcid;
  ...
  function getDataList(){
	...
	function exportCSV( $list ){
	 ...
	 public function delete() { 
		    ...
		    $message = $getid && $status ? 'Data Deleted Successfully' :'Some Error Occurred';
		    $this->session->set_flashdata('error', $message ); 
		    
		    redirect( adminurl('vehicle_service_list?vcid='.$vcid.'&status='.$redirect ));
